                ...
                <div class="row g-3">
                        ...
                        <form action="/reviews/add" method="post" class="m-3 w-100">
                            ...
                            <div class="form-floating mt-2">
                                <textarea
                                    ...
                                    name="comment" placeholder="Укажи свое мнение о фильме" id="floatingTextarea2"
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text">Оценка <span
                                    class="badge bg-warning warn__badge"><?php echo '7,8'//$movie->avgRating() ?></span>
                            </p>
                            <p class="card-text"><?php echo $movie->description() ?></p>
                            <p class="card-text"><small class="text-body-secondary">Добавлен
                                    <?php echo $movie->created_at() ?></small></p>
                            <h4>Отзывы</h4>
